...
class NEURON: 
    ...
    def Update_Sensor_Neuron(self):
        ...
        # print(self.Get_Link_Name(),": ",self.value);
    ...
    def Update_Hidden_Or_Motor_Neuron(self, neurons, synapses):
        for key in synapses.keys():
            if(key[1]==self.Get_Name()):
                ...
                # print(self.Get_Value(), neurons[key[0]].Get_Value())
        self.Threshold()
        # print(self.name,"value :",self.Get_Value())

    def Allow_Presynaptic_Neuron_To_Influence_Me(self, weight, preSynapticValue):
        self.Add_To_Value(preSynapticValue*weight)
